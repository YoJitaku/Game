...
HRESULT InitMenu(void)
{
	...
	pMenu[0].bUse = true;
	pMenu[0].pos = D3DXVECTOR3(WIDTH_SCREEN / 2 - 250 , HEIGHT_SCREEN / 2, 0);
	...
	pMenu[1].bUse = true;
	pMenu[1].pos = D3DXVECTOR3(WIDTH_SCREEN / 2 , HEIGHT_SCREEN / 2, 0);
	...
	pMenu[2].bUse = true;
	pMenu[2].pos = D3DXVECTOR3(WIDTH_SCREEN / 2 , HEIGHT_SCREEN / 2 + 150, 0);
...
void UpdateMenu(void)
{
	...
	{
		pMenu[0].pos.y -= 150;
		if (pMenu[0].pos.y < HEIGHT_SCREEN / 2) pMenu[0].pos.y = HEIGHT_SCREEN / 2 + 300;
	}
	if (GetkeyboardTrigger(DIK_S) == true)
	{
		pMenu[0].pos.y += 150;
		if (pMenu[0].pos.y > HEIGHT_SCREEN / 2 + 300) pMenu[0].pos.y = HEIGHT_SCREEN / 2;
	}
