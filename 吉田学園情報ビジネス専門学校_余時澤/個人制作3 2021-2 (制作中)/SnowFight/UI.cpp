...
HRESULT InitUI(void)
{
	...
	//スラッシュ
	//if (FAILED(D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/UI/Slash.png", &g_pTextureUI[0])))return E_FAIL;
	//pUIPoly[0].bUse = true;
	//pUIPoly[0].pos = D3DXVECTOR3(1700, 950, 0);
	//pUIPoly[0].size = D3DXVECTOR2(150, 50);
