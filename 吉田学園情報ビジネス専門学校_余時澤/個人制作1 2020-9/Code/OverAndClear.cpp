...
HRESULT InitOAC(void)
{
	...
	g_nCntTimeOAC = 0;
	g_aOAC[0].bUse = false;
	g_aOAC[0].size = D3DXVECTOR2(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2);
	g_aOAC[0].pos = D3DXVECTOR3(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 0.0f);
	g_aOAC[1].bUse = false;
	g_aOAC[1].size = D3DXVECTOR2(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2);
	g_aOAC[1].pos = D3DXVECTOR3(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 0.0f);
